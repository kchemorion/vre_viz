...
emcc --bind -s DEMANGLE_SUPPORT=1 -I ../../../vcglib/ MeshLabJs.cpp Opener.cpp Refine.cpp Smooth.cpp ../../../vcglib/wrap/ply/plylib.cpp  -s TOTAL_MEMORY=268435456 -O3 -o MeshlabJs.js
