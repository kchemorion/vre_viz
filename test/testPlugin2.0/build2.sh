...
echo "compiling Opener..."
emcc --bind -s DEMANGLE_SUPPORT=1 -I ../../../vcglib/ Opener.cpp ../../../vcglib/wrap/ply/plylib.cpp  -s TOTAL_MEMORY=268435456  -o Opener.js
echo "compiling Refine..."
emcc --bind -s DEMANGLE_SUPPORT=1 -I ../../../vcglib/ Refine.cpp  -s TOTAL_MEMORY=268435456  -o Refine.js
